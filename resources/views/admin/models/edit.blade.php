<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">Editar modelo</h1>
                <p class="mt-1 text-sm text-gray-500">Ajuste as informações do modelo selecionado.</p>
            </div>
    ...
    <div class="py-8">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('admin.models.update', $model) }}" class="space-y-6 rounded-2xl bg-white p-8 shadow ring-1 ring-gray-200">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" value="{{ old('name', $model->name) }}" required />
                </div>
